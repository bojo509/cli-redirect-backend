...
export const register = async (username, email, password) => {
    ...
    return await sql("SELECT username, email FROM users WHERE username = $1;", [username]);
};
...
export const login = async (username) => await sql("SELECT username, email, password FROM users WHERE username = $1;", [username]);
